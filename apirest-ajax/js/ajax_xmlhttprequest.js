((d, c, w) => {
    ...
    const obtenerArticulos = () => {
        Ajax_xhr({
            ...
            method: "GET",
            ApiKey: "Basic UjJhUjA3Umtqazh1aDgyNThmZHNrRU9JRU4yNXVkbjVpRld2ejBmMUVWLllYczRNdTI4dXZjZVEyY0tLOlQyYVQwN1Rrams4dWg4MjU4ZmRza0VPSUVOMjV1NDlxMHd6NW02NDVDeVdNQlJ2OTFsZVgzUUZiZjFMLg==",
            success(objetoJSON) {
                if (!objetoJSON.articulos) {
                    c.log(objetoJSON);
                    return;
                }
